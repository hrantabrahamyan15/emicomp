export const environment = {
  ...
  questions_ru: [
    // {q: 'Готовы ли Вы принимать участие в тестировании новых возможностей сервиса за пополнение баланса?', type: 'radio', a: ['Да', 'Нет']},
    {q: '1. Есть ли у вас криптокошелек Metamask?', type: 'radio', a: ['Да', 'Нет'], question_num: 1},
    {q: '2. Какие деньги вам хотелось бы внести? ', type: 'checkbox', a: [{name: 'Наличные', completed: false}, {name: 'Карта', completed: false}, {name: 'Безналичные на счету юридической фирмы', completed: false}, {name: 'Безналичные на счету ИП', completed: false}, {name: 'Криптовалюта на кошельке', completed: false}], question_num: 2},
    {q: '3. Есть ли аккаунт на Binance  или любой другой криптобирже?', type: 'radio', a: ['Да', 'Нет'], question_num: 3},
  ],
};
